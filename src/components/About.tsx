...
const About = () => {
  return (
    <section id="ueber-uns" className="relative pt-12 md:pt-20 pb-12 md:pb-32 bg-background">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-6">
              Ihr zuverlässiger Partner für gepflegte Außenanlagen und gesunde Bäume
            </h2>
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              <p>
                Ich bin ein zuverlässiger Dienstleister für Garten- und Landschaftspflege 
              ...
              <p>
                ...
                bei mir an erster Stelle. Dabei denke und arbeite ich nachhaltig – mit einem verantwortungsvollen 
                Umgang mit Natur, Pflanzen und Ressourcen. Als Ihr persönlicher Ansprechpartner sorge ich dafür, 
                dass Ihr Garten zu jeder Jahreszeit in besten Händen ist.
              </p>
              <p>
